...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Yanzzx Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        ...
        try:
            ...
            await ASS_CLI_1.join_chat("yanzzxsupport")
        except:
            pass
    ...
    if STRING2 != "None":
        ...
        try:
            ...
            await ASS_CLI_2.join_chat("yanzzxsupport")
        except:
            pass
    ...
    if STRING3 != "None":
        ...
        try:
            ...
            await ASS_CLI_3.join_chat("yanzzxsupport")
        except:
            pass
    ...
    if STRING4 != "None":
        ...
        try:
            ...
            await ASS_CLI_4.join_chat("yanzzxsupport")
        except:
            pass
    ...
    if STRING5 != "None":
        ...
        try:
            ...
            await ASS_CLI_5.join_chat("yanzzxsupport")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        ...
        try:
            ...
            await LOG_CLIENT.join_chat("yanzzxsupport")
        except:
            pass
    console.print(f"└[red] Yanzzx Music Bot Boot Completed.")
    if STRING1 != "None":
